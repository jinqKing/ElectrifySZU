window.ElectrifySZUI18n = {
  translations: {
    "zh-CN": {
      ...
      "subscribe.saved": "验证邮件已发送，请点击邮件中的确认链接后启用预警。",
      "subscribe.needsBackend": "订阅功能需要后端服务，GitHub Pages 预览页不会保存邮箱。",
      "notice.verified": "{email} 已完成邮箱验证，{campus} {building} {room} 的低电量提醒已启用。",
      "notice.alreadyVerified": "{email} 之前已经验证过，{campus} {building} {room} 的提醒仍处于启用状态。",
    ...
    "en-US": {
      ...
      "subscribe.saved": "Verification email sent. Confirm it to enable alerts.",
      "subscribe.needsBackend": "Subscriptions need the backend service; the GitHub Pages preview will not save email addresses.",
      "notice.verified": "{email} is verified. Low-balance alerts for {campus} {building} {room} are now enabled.",
      "notice.alreadyVerified": "{email} was already verified. Alerts for {campus} {building} {room} remain enabled.",
